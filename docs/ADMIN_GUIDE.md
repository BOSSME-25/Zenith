...
A quick-start manual for managing zenithprep.org.

---

## 1. Logging in

1. Go to **https://zenith-rho-eight.vercel.app/admin**
...
Inside Families, Community, Partners, or Contacts you can:
...
Updates are public announcements that appear at **zenithprep.org/updates** and are linked from the site header and footer.
...
The post is now live at `zenithprep.org/updates/your-slug`.
...
The community survey lives on **https://zenithprep.org/get-involved#survey** and is powered by Google Forms (English + Spanish).
...
These are the parts of zenithprep.org that visitors see. Content for these pages is currently maintained by Emily in the codebase — to change copy, photos, or board bios, send the requested changes to Emily.
...
| Change a homepage stat or photo | Email Emily |
